...
protected:
	...
	// Per-surface footstep tuning is now individual cvars
	// (weird.Footstep.<Surface>.Pitch/Jitter/Volume) — tune via the in-game
	// Tunables menu, the console, or uq/MCP cvar tools.
