 ...
 ("3D View Tool: Paint Grease Pencil, Arc",
  ...
  {"items":
   [("grease_pencil.primitive_arc", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ...
    ("grease_pencil.select_lasso", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "alt": True}, None),
    ...
    ("grease_pencil.select_lasso", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ],
   },
  ),
