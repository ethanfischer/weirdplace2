...
- 🟡 **First-play fog wall + bladder indicator (investigation + partial fix)** — mechanism identified with evidence; vignette warmup implemented; **needs your fresh-editor-launch verification in the morning** (this is the item's ratified fallback: the exact symptom didn't reproduce in the harness).
