...
class FN2CPythonSyntaxDefinition : public FN2CSyntaxDefinition
{
public:
    FN2CPythonSyntaxDefinition();
    ...
    virtual EN2CCodeLanguage GetLanguage() const override { return EN2CCodeLanguage::Python; }
};
