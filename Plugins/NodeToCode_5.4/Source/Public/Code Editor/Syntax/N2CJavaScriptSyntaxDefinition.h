...
class FN2CJavaScriptSyntaxDefinition : public FN2CSyntaxDefinition
{
public:
    FN2CJavaScriptSyntaxDefinition();
    ...
    virtual EN2CCodeLanguage GetLanguage() const override { return EN2CCodeLanguage::JavaScript; }
};
