...
class FN2CSwiftSyntaxDefinition : public FN2CSyntaxDefinition
{
public:
    FN2CSwiftSyntaxDefinition();
    ...
    virtual EN2CCodeLanguage GetLanguage() const override { return EN2CCodeLanguage::Swift; }
};
