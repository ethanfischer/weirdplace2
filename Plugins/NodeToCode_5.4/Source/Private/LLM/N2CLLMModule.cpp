    ...
    const FOnLLMResponseReceived& OnComplete)
{
    ...
    // Capture OnComplete to invoke it when processing finishes
            ...
            if (ActiveServiceParser.GetInterface())
            {
                ...
                if (Parser)
                {
                    if (Parser->ParseLLMResponse(Response, TranslationResponse))
                    {
                        ...
                        // Call the original completion callback with the response
                    ...
                    else
                    {
                        ...
                        // Call the original completion callback with empty response to indicate failure
